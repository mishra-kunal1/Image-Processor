...
public class HorizontalFlipCommand extends Command {
  public HorizontalFlipCommand(IModel model, IView view) {
    super(model, view);
  }
  ...
  protected void execute(String[] args) {
    ...
    model.horizontalFlip(name, destImageName);
    callViewSuccess("Horizontal flip operation executed successfully.");
  }
