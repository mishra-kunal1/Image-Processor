...
public class GreenComponentCommand extends Command {
  public GreenComponentCommand(IModel model, IView view) {
    super(model, view);
  }
  ...
  protected void execute(String[] args) {
    ...
    model.greenComponent(name, destImageName);
    callViewSuccess("Green component operation executed successfully.");
  }
