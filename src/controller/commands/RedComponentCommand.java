...
public class RedComponentCommand extends Command {
  public RedComponentCommand(IModel model, IView view) {
    super(model, view);
  }
  ...
  protected void execute(String[] args) {
    ...
    model.redComponent(name, destImageName);
    callViewSuccess("Red component operation executed successfully.");
  }
