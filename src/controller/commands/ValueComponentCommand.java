...
public class ValueComponentCommand extends Command {
  public ValueComponentCommand(IModel model, IView view) {
    super(model, view);
  }
  ...
  protected void execute(String[] args) {
    ...
    model.calculateValue(name, destImageName);
    callViewSuccess("Value component operation executed successfully.");
  }
